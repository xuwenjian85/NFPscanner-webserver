(function() {
    ...
    function b(X) {
        ...
        Y.append("text").attr("font-size", 0).attr("class", "label").on("mouseover", function(){
        	jQuery(".ex-tooltip").text(jQuery(this).text())
        	.css({top: jQuery(this).offset().top, left: jQuery(this).offset().left})
            .show();
        }).on("mouseout", function(){
        	jQuery(".ex-tooltip").hide();
        }).on("click",G);
