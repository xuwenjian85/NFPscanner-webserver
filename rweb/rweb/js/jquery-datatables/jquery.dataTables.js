...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 *
		 *  @example
		 *    // Show an console.warn with the filtering value that was saved
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "stateSave": true,
	...
	DataTable.ext = _ext = {
		 ...
		 * Error reporting.
		 * 
		 * How should DataTables report an error. Can take the value 'console.warn',
		 * 'throw', 'none' or a function.
		 *
		 *  @type string|function
		 *  @default console.warn
		 */
		errMode: "console.warn",
